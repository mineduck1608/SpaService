      ...
      <div className='footer-container'>
        ...
        <div className='footer-info'>
          ...
          <div className="item flex mb-6 w-full">
            ...
            <h5 className="w-[120px] m-0 shrink-0 text-[#b1aeaa]"><FontAwesomeIcon icon={faMap} className="mr-2" /> Address:</h5>
            <div className='content text_white flex-1 break-words ml-10 text-[#b1aeaa]'>10B1 Le Thanh Ton, Ben Nghe Ward, District 1, HCMC</div>
          </div>
          <div className="item flex mb-6 w-full">
            <h5 className="w-[120px] m-0 shrink-0 text-[#b1aeaa]"><FontAwesomeIcon icon={faPhone} className="mr-2" /> Phone:</h5>
            <div className='content text_white flex-1 break-words ml-10 text-[#b1aeaa]'>+84 28 38 251 250 <br /> +84 28 3910 2174</div>
          </div>
          <div className="item flex mb-6 w-full">
            <h5 className="w-[120px] m-0 shrink-0 text-[#b1aeaa]"><FontAwesomeIcon icon={faEnvelope} className="mr-2" /> Email:</h5>
            <div className='content text_white flex-1 break-words ml-10 text-[#b1aeaa]'>rsv@senspa.com.vn</div>
          </div>
          <div className="item flex mb-6 w-full">
            <h5 className="w-[120px] m-0 shrink-0 text-[#b1aeaa]"><FontAwesomeIcon icon={faClock} className="mr-2" /> Opening:</h5>
