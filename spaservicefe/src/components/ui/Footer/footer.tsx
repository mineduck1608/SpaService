    ...
    <footer className='footer'>
      <div className='footer-container'>
        <div className='footer-logo'>
          ...
          <div className='mt-4'>
            <a
              ...
              className='mx-2.5 inline-block text-2xl text-white no-underline hover:text-[#976418]'
            >
        ...
        <div className='footer-info'>
          ...
          <p>
            <strong>Address:</strong> 10B1 Le Thanh Ton, Ben Nghe Ward, District 1, HCMC
          </p>
          <p>
            <strong>Phone:</strong> +84 28 38 251 250 | +84 28 3910 2174
          </p>
          <p>
            <strong>Email:</strong> rsv@senspa.com.vn
          </p>
          <p>
            <strong>Opening time:</strong> 09:30 AM - 20:00 PM
          </p>
          <p>
      ...
      <div className='footer-bottom mt-2.5 w-full bg-[#976418] py-2.5'>
