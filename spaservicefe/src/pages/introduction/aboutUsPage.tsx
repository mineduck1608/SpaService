...
const AboutUsPage = () => {
    const SpaData = [
        { id: 1, image: "https://senspa.com.vn/wp-content/uploads/2020/12/icon-5.png", title: "Hearing",  description: "Calming melodies help relieve stress and depression so you can slowly drift into deep sleep.", aosDelay: "300"},
        { id: 2, image: "https://senspa.com.vn/wp-content/uploads/2020/12/icon-1.png", title: "Smell", description: "The nose is welcomed by the pleasant aroma of plants and natural essential oil covering the entire floors.", aosDelay: "500" },
        { id: 3, image: "https://senspa.com.vn/wp-content/uploads/2020/12/icon-4.png", title: "Touch", description: "Your bright smooth skin will be well cared for with gentle strokes to remove all muscle knots.", aosDelay: "700" },
        { id: 4, image: "https://senspa.com.vn/wp-content/uploads/2020/12/icon-2.png", title: "Visual", description: "Minimalistic decoration and gentle lighting help transcend your spirit to another realm and drown your body in deep relaxing moments.", aosDelay: "900" },
        { id: 5, image: "https://senspa.com.vn/wp-content/uploads/2020/12/icon-3.png", title: "Taste", description: "Not only is our special drink delicious, but it is also rejuvenating for your health and skin.", aosDelay: "1100" },
    ]
    useEffect(() => {
        AOS.init({
            offset: 0,
