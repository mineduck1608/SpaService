  ...
  return (
    <div className='flex min-h-80 content-center items-center justify-center bg-slate-600 p-32'>
      <div className='w-full max-w-md rounded-lg bg-white p-6 shadow-md'>
        ...
        <div className="mb-5 relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
          <span className="relative z-10 bg-background px-2 text-muted-foreground">
            Or
          </span>
        </div>
        <button className='flex w-full items-center justify-center bg-slate-300'>
          <div className='mr-2 mt-6 flex h-8 -translate-y-3 items-center justify-center rounded-full bg-white p-1'>
