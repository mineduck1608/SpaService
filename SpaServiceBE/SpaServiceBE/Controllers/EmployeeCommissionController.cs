        ...
        public async Task<ActionResult> CreateEmployeeCommission([FromBody] dynamic request)
        {
            try
            {
                ...
                return CreatedAtAction(nameof(GetEmployeeCommissionById),
                    new { employeeId = employeeCommission.EmployeeId, commissionId = employeeCommission.CommissionId, transactionId = employeeCommission.TransactionId }, new { employeeId = employeeCommission.EmployeeId, commissionId = employeeCommission.CommissionId, transactionId = employeeCommission.TransactionId });
            }
            catch (Exception ex)
            {
